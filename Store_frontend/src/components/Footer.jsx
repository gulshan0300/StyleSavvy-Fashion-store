...
const Footer = () => {
  return (
    <Container>
      <Left>
        <Logo>StyleSavvy</Logo>
        <Desc>
        StyleSavvy has some awesome values for their fitness and every day line. They focus on being green, providing quality and practical pieces and is run by family and valued by family. They have adorable styles for men, women, and kids.
        </Desc>
        <SocialContainer>
      ...
      <Right>
            ...
            <ContactItem><Room style={{marginRight:'10px'}}/>
                   700 main road , Adarsh Nagar, Delhi 110033
            </ContactItem>
            <ContactItem><Phone style={{marginRight:'10px'}}/>+91 8810525282</ContactItem>
            <ContactItem><MailOutline style={{marginRight:'10px'}}/><a className='link' href='mailto:gulshan0300@gmail.com'>gulshan0300@gmail.com</a></ContactItem>
